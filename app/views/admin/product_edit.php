...
<head>
    ...
    <title>Edit Product - Admin FreshJuice</title>
    ...
    <style>
        ...
        .upload-area { border: 2px dashed #e5e7eb; border-radius: 12px; padding: 20px; text-align: center; background: #f9fafb; }
...
<div class="dashboard-wrapper">
    ...
    <div class="main-content">
        ...
        <form action="index.php?action=admin_product_update&id=<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="header-actions">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="fw-bold m-0"><i class="fas fa-edit me-2"></i>Edit Product</h4>
                </div>
                <div>
                    <a href="index.php?action=admin_products" class="btn btn-light border fw-semibold me-2">Cancel</a>
                    <button type="submit" class="btn btn-success fw-semibold"><i class="fas fa-check me-2"></i>Save Changes</button>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="form-card h-100 mb-0">
                        ...
                        <div class="text-center mb-3">
                            <img src="public/images/<?= htmlspecialchars($product['image']) ?>" style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px;">
                        </div>
                        <div class="upload-area">
                            <small class="text-muted">Change image:</small>
                            <input type="file" name="image" class="form-control mt-2" accept="image/png, image/jpeg">
                        </div>
                    </div>
                </div>
            </div>
